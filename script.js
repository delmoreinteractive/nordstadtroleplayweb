...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (dispatchTitle) dispatchTitle.textContent = siteConfig.dispatch.title;
  if (dispatchText) dispatchText.textContent = siteConfig.dispatch.text;
  ...
  if (statusHeadline) statusHeadline.textContent = siteConfig.status.headline;
  if (statusDescription) statusDescription.textContent = siteConfig.status.description;
